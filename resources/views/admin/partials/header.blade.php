...
<head>
    ...
    <!-- start: CSS -->
    <link id="bootstrap-style" href="{{URL::asset('vendor/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{URL::asset('vendor/css/bootstrap-responsive.min.css')}}" rel="stylesheet">
    <link id="base-style" href="{{URL::asset('vendor/css/style.css')}}" rel="stylesheet">
    <link id="base-style-responsive" href="{{URL::asset('vendor/css/style-responsive.css')}}" rel="stylesheet">
